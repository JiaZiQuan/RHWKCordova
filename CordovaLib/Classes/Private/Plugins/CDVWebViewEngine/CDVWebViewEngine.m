...
static NSString * SSO_URL = @"/ruaho_sso_listener.html";
...
- (void)pluginInitialize
{
    ...
    [[CDVWebViewProcessPoolFactory sharedFactory] setWebViewCookie:wkWebView];
...
- (void) webView: (WKWebView *) webView decidePolicyForNavigationAction: (WKNavigationAction*) navigationAction decisionHandler: (void (^)(WKNavigationActionPolicy)) decisionHandler
{
    ...
    CDVViewController* vc = (CDVViewController*)self.viewController;
    if ([[url absoluteString] containsString:SSO_URL]) {
        [[NSNotificationCenter defaultCenter] postNotification:[NSNotification notificationWithName:CDVSSOURLNotification object:url]];
